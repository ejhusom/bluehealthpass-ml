...
def scale(dir_path):
    ...
    elif input_method == "log":
        input_scaler = FunctionTransformer(np.log1p, validate=True)
    ...
    elif output_method == "log":
        output_scaler = FunctionTransformer(np.log1p, validate=True)
